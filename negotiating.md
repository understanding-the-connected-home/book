...
_As we invite more algorithmic agents into our lives, we'll see more conflicts both between them and us as well as between one another. How can we understand and mediate these conflicts?_
...
- **We need a Do Not Track for the physical space.** As a lowest-common denominator, we might need Do Not Track not just for connected homes, but especially for smart cities and connected retails spaces: A device of sorts that allows us to reliably opt out of marketing & advertising tracking.

**These rules and types of interactions need to be human and machine readable.** For any of this to work, we need to come up with a way to communicate these rules in a format that is legible by humans and machines alike (like Creative Commons licenses[^1]). In other words, standardization for different types of data-based interactions.
...
[^2]: Watch Louisa Heinrich's [talk at NEXT14](http://video.nextconf.eu/v.ihtml?photo%5fid=9802229), esp. around the 7 minute mark. For more of her thinking, see [Louisa Heinrich](http://louisaheinrich.com)
